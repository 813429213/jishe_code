...
from deblurring.deblur import deblur1


# noinspection PyArgumentList,PyUnresolvedReferences,PyCallByClass
class MainWidget(QWidget):
    DEFAULT_MODEL_PATH = (Path(__file__).parent / 'deblurring/models').absolute()
    ...
    def __init__(self):
        ...
        self.model = str(self.DEFAULT_MODEL_PATH / 'model_deblurring.pth')

        self.setWindowTitle('dataBLUR')
    ...
    def upscale(self):
        try:
            ...
            self.thread.started.connect(self.worker.process_deblur)
...
if __name__ == '__main__':
    app = QApplication([])
    app.setApplicationName('dataBLUR')
